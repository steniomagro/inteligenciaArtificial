...
public class MelhorPrimeiro {
    
    public void melhorPrimeiro(){
		...
		BuscaInformada bi = new BestFirst();

		bi.setInicio(puzzleInicial);
		bi.setObjetivo(puzzleFinal);
		bi.buscar();
		
		if(bi.getCaminhoSolucao().isEmpty())	
			System.out.println("Nao foi achada uma solucao!");

		for(Estado e: bi.getCaminhoSolucao()) {
